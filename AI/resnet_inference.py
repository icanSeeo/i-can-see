...
if __name__ == "__main__":
    ...
    class BikesvsCarsvsDogsvsCatsDataset(Dataset):
    ...
    train_dataset = BikesvsCarsvsDogsvsCatsDataset(
        train_images_filepaths, transform=ImageTransform(size, mean, std), phase='train')
    val_dataset = BikesvsCarsvsDogsvsCatsDataset(
    ...
    wandb.run.name = 'resnet_train_v11'
    ...
    with torch.no_grad():
        for test_path in test_images_filepaths:
            ...
            id_list.append(_id)
            pred_list.append(preds_label_idx)
